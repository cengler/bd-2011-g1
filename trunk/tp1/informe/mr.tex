...
\begin{enumerate}
	...
	$r2.codDirOrigen = r1.codDirOrigen))$ \footnote{Ver restricción \ref{MER1} del MER} 
	\item $Recorrido.codDirOrigen \neq Recorrido.codDirDestino$	
	\footnote{Ver restricción \ref{MER2} del MER}
	...
	\footnote{Ver restricción \ref{MER3} del MER}
...
\footnote{Ver restricción \ref{MER4} del MER}	
	...
	\footnote{Ver restricción \ref{MER5} del MER}
	...
	\footnote{Ver restricción \ref{MER6} del MER}
...
\footnote{Ver restricción \ref{MER8} del MER}
	...
	\footnote{Ver restricción \ref{MER10} del MER}
	...
	\footnote{Ver restricción \ref{MER11} del MER}
...
\footnote{Ver restricción \ref{MER12} del MER}
...
\footnote{Ver restricción \ref{MER13} del MER}
\end{enumerate}
