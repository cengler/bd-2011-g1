...
\resumen{El presente trabajo evalúa el impacto de la utilización de diferentes estrategias de reemplazo de páginas en la implementación de ciertas operaciones sobre una BD. Se analiza la importancia del módulo Buffer Manager en el contexto de un motor de  BD.}
