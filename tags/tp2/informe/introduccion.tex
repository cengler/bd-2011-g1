...
Ejemplo: si queremos hacer un join entre dos relaciones $A$ y $C$, y contamos con 100 bloques en memoria, el algoritmo indica que tenemos que dedicar (100-2) bloques para $A$ y 1 bloque para $C$ dejando uno libre para el resultado.\\ Como asumimos que tenemos un bloque extra de memoria para el resultado necesitaríamos dedicar 1 bloque para $C$ y (101-2) para $A$.
\end{itemize}
