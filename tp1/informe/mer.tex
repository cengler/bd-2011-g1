...
\begin{enumerate}
	\item Dado 2 recorridos con distinto codigo, su origen y destino no pueden ser los mismos. Es decir, no puede haber dos recorridos ``iguales''con distinto código. \label{MER1}
	...
	\item La entidad Esación puede tomar los valores, \textit{verano}, \textit{invierno}, \textit{otoño} y \textit{primavera} \label{MER13}
\end{enumerate}
